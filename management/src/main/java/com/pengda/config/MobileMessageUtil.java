...
public class MobileMessageUtil {
    ...
    private static String accessKeyId = "LTAICGYW1TLDDK0E";                      //你的accessKeyId
    private static String accessKeySecret = "zB1tuMXClfzzTRU19BheATCnmcjrBF";  //你的accessKeySecret
    private static String signName = "彭达";                                      //你的签名名称
    private static String identifyingTempleteCode = "SMS_132320009";            //你的模板Code
    private static String registTempleteCode = "SMS_132320009";                 //你的注册模板Code
    ...
    public static void main(String[] args){
        // 发短信
        SendSmsResponse response = MobileMessageUtil.sendIdentifyingCode("13522730619", "123456");
        ...
        response = MobileMessageUtil.sendNewUserNotice("18610249527", "彭达", "4512");
        System.out.println("短信接口返回的数据----------------");
        System.out.println("Code=" + response.getCode());
        System.out.println("Message=" + response.getMessage());
        System.out.println("RequestId=" + response.getRequestId());
